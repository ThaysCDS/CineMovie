...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_operators__ = __webpack_require__(275);
...
var BuscaProvider = /** @class */ (function () {
    function BuscaProvider(http) {
        this.http = http;
        console.log('Hello BuscaProvider Provider');
    }
    BuscaProvider.prototype.searchMovies = function (val) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.http.get('https://api.themoviedb.org/3/search/movie?api_key=e0d4493421373f6f99b25a46d61675d9&language=pt-BR&page=1&include_adult=false&query=' + val)
                            .pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["map"])(function (data) { return data; })).toPromise()];
                    case 1:
                        response = _a.sent();
    ...
    BuscaProvider.prototype.getMovies = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.http.get('https://api.themoviedb.org/3/movie/popular?api_key=e0d4493421373f6f99b25a46d61675d9&language=pt-BR&page=1')
                            .pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["map"])(function (data) { return data; })).toPromise()];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.results];
...
//# sourceMappingURL=busca.provider.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_common_http__ = __webpack_require__(179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_storage__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_busca_busca_provider__ = __webpack_require__(242);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__providers_busca_busca_provider__["a" /* BuscaProvider */],
            ]
        })
    ], AppModule);
    return AppModule;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\thays.c.silva\Documents\Workspace\Movies\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\Users\thays.c.silva\Documents\Workspace\Movies\src\app\app.html"*/
        }),
